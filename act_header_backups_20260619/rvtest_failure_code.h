...
.macro RVTEST_FAILURE_DATA
    ...
    saved_mtval:                                 # mtval snapshotted at failedtest_trap_x7_x9 entry
        .fill 2, 4, 0
    saved_mstatus:                               # mstatus snapshotted at ACT trap entry
        .fill 2, 4, 0
    saved_mhartid:                               # mhartid snapshotted at ACT M-mode trap entry
        .fill 2, 4, 0
    saved_mie:
        .fill 2, 4, 0
    saved_mip:
